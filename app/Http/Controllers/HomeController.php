    ...
    if(Auth::id()){
         ...
         if($role == 'student'){
            ...
            if($employeeprofile !== null){
               ...
               return redirect()->route('registrarhome')->with('message', 'Successfully Created an Account');
            }else{
               return redirect()->route('registrar.createprofile')->with('message', 'Successfully Created an Account');
            }
